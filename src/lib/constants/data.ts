export const teamMembers = [
  {
    ...
    role_description: ["As CEO, Umer oversees strategic operations, fosters relationships with key stakeholders and donors, and guides collaborations with national and international partners, including Al-Sharq Forum and Khalq Clinic, to advance the organization’s mission and global engagement."],
  ...
  },
  {
    ...
    role: "COO",
    background: [
      "With a background in Statistics, Fateh Muhammad currently works as a Data Analyst at Teach The World Foundation, which uses gamification to combat illiteracy among out-of-school children. He is also pursuing an MPhil in Education Leadership and Management from LUMS, and serves as the Chief Operating Officer of Daadras Foundation.",
    ],
    joining_story: [
      "I joined Daadras Foundation after a conversation with my close friend and founder Omar Zafar, about the kind of education that could create lasting impact in underserved communities. Together, we envisioned a holistic learning model that integrates Information Technology (IT), Social Emotional Learning (SEL), Strategic Thinking through chess, and Public Speaking—giving children the tools to think critically, build emotional resilience, and express themselves confidently.",
    ],
    role_description: [
    ...
    image: "/assets/team_photos/coo_fateh.png",
    socialLinks: {
  ...
  },
  {
    ...
    image: "/assets/team_photos/project_director_salam_arooj.png",
    socialLinks: {
  ...
  },
  {
    ...
    role_description: [
      "At Daadras, Abdul Muqadim leads the marketing and communications initiatives, heading efforts to amplify the organization's voice and expand its reach. He oversees all marketing strategies, public relations campaigns, and digital outreach activities to ensure that Daadras’ mission resonates widely and authentically.",
      "From crafting compelling narratives to executing strategic outreach plans, Abdul’s work ensures that Daadras remains visible, impactful, and connected with the communities it serves. His leadership in marketing strengthens the organization’s ability to grow sustainably while inspiring greater participation and support for its educational initiatives.",
    ],
    image: "/assets/team_photos/head_of_marketing_muqadim.jpg",
    socialLinks: {
  ...
  },
  {
    ...
    image: "/assets/team_photos/head_of_sel_shanzay.jpg",
    socialLinks: {
  ...
  },
  {
    ...
    role_description: [
      "At Daadras, I serves as the Head of Strategic Gaming. In this role, I designs and leads programs that use chess and other strategic games to strengthen critical thinking, decision-making, emotional regulation, and resilience among orphans enrolled in the Salam Project. My work is focused on ensuring that strategic play becomes a tool for real-world empowerment, providing children with essential life skills that extend far beyond the game itself.",
    ],
    image: "/assets/team_photos/head_of_strategic_gaming_sarmad_sabir.png",
    socialLinks: {
  ...
  },
  {
    ...
    role: "Director IT",
    background: [
      "Sawaiz Naseem is a Machine Learning Engineer and AI Researcher with a deep commitment to applying technology for real-world impact. His work spans across fields like Computer Vision, Natural Language Processing, Reinforcement Learning, and Data Analytics, with hands-on experience in both academic research and industry projects.",
      "Beyond his technical achievements, Sawaiz is passionate about education. Over the years, he has taught Computer Science to students at all levels — from primary school children to university graduates — helping them build strong foundations in technology, critical thinking, and problem-solving.",
    ],
    joining_story: [
    ...
    image: "/assets/team_photos/head_of_it_sawaiz.jpg",
    socialLinks: {
  ...
  },
  {
    ...
    role_description: [
      "When Daadras began, Abdullah advocated to bridge the gaps through education and small-business initiatives. He believed skills, not handouts, are the foundation of lasting change. Whether teaching public speaking, guiding new entrepreneurs, or creating learning programs, his focus has always been on helping people build their own futures.",
    ],
    image: "/assets/team_photos/head_of_public_speaking_abdullah_farrukh.png",
    socialLinks: {
...
export const blogs = [
  {
    ...
    excerpt:
      "Daadras is proud to announce a new program aimed at increasing literacy rates in remote communities.",
    date: "April 25, 2025",
  ...
  },
  {
    ...
    excerpt:
      "Providing emergency shelter and aid to families affected by severe winters in northern regions.",
    date: "March 10, 2025",
  ...
  },
  {
    ...
    excerpt:
      "Celebrating the success of our skills training workshops across three provinces.",
