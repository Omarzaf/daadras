export const teamMembers = [
  {
    ...
    tenure_end: "Present",
    bio: ["I founded Daadras Foundation believing real development starts where states fall short—at the grassroots. Growing up amid poverty, I saw children denied agency and aspiration. Daadras equips underprivileged youth with education, skills training, and critical thinking. Our goal is empowerment, not charity—helping children become earners, thinkers, and leaders who transform their lives and communities through dignity, opportunity, and self-determination."],
  ...
  },
  {
    ...
    role: "COO",
    department: ["Administration"],
    education: "Currently pursuing Master's in Education from Lahore University of Management Sciences, Lahore",
  ...
  },
  {
    ...
    education: "Major in Sociology and Literature",
...

{
    ...
    role: "Research Assistant",
    department: ["Research"],
    education: "Bachelor’s in Comparative Religions; pursuing Post Graduate Diploma in Muslim Law and Jurisprudence and a degree in Mechanical Engineering",
    tenure_start: "September 2025",
    tenure_end: "Present",
...

{
    ...
    role: "Deputy Director Strategic Gaming",
    department: ["Strategic Gaming", "Salam"],
    education: "Pursuing Bachelor's in Philosophy at Forman Christian College, Lahore (Minors in Theology and Sociology)",
    tenure_start: "September 2025",
    tenure_end: "Present",
  ...
  },
  {
    ...
    education: "BBA (Bachelor of Business Administration), Specialization in Marketing",
    tenure_start: "September 2025",
    tenure_end: "Present",
