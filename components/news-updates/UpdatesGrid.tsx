...
import { NoArticlesAvailable } from "@/components/ui/no-articles"
...
export function UpdatesGrid({ articles, hasFilters = false }: UpdatesGridProps) {
  // If no articles are available, show the empty state
  if (articles.length === 0) {
    return <NoArticlesAvailable hasFilters={hasFilters} />
  }
