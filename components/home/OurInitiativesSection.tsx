...
const MetricCard = ({ metric, onHover, onLeave, isHovered }: {
  metric: MetricData
  onHover: () => void
  onLeave: () => void
  isHovered: boolean
  ...
  return (
    <motion.div 
      ...
      animate={isFamiliesMetric && !hasBeenHovered ? {
        y: [0, -7, 0],
      } : undefined}
      transition={isFamiliesMetric && !hasBeenHovered ? {
        duration: 2,
        repeat: Infinity,
        ease: "easeInOut"
      } : undefined}
    ...
    >
      <div className="relative z-10">
        <div className="text-xl font-bold text-[#0F443F] mb-1">{metric.value}</div>
...
const AnimatedChart = ({ hoveredMetric, metrics }: {
...
const InitiativeCard = ({ initiative, children }: {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.6, delay: initiative.id === 'economic' ? 0.2 : 0.4 }}
      className="group"
    >
...
export const OurInitiativesSection = () => {
  ...
  const [hoveredEmergencyMetric, setHoveredEmergencyMetric] = useState<string | null>(null)

  // Memoized data with logarithmic scaling for proportional chart representation
  const metrics = useMemo<MetricData[]>(() => [
    { id: 'people', icon: Users, value: '100+', label: 'Families supported with self-sustainability programs', path: 'M 0 300 Q 40 260 80 200 Q 120 140 160 100 Q 200 70 240 50 Q 280 35 320 25 Q 360 20 400 15' },
    { id: 'projects', icon: Heart, value: '20+', label: 'Sewing machines & small business tools distributed', path: 'M 0 300 Q 50 275 100 250 Q 150 225 200 200 Q 250 180 300 165 Q 350 155 400 150' },
    { id: 'communities', icon: Globe, value: '5+', label: 'Students sponsored for continued education', path: 'M 0 300 Q 50 285 100 270 Q 150 255 200 245 Q 250 235 300 230 Q 350 225 400 220' },
    { id: 'success', icon: Award, value: '3+', label: 'Community initiatives strengthened', path: 'M 0 300 Q 50 290 100 280 Q 150 270 200 265 Q 250 260 300 255 Q 350 250 400 245' }
  ], [])

  const emergencyImages = useMemo(() => ({
    'Ration Packages': '/drive/ration_package.jpeg',
    'Families fed through food & cash assistance': '/drive/help_charity_kids.webp',
    'Iftar drives and meal distributions organized': '/drive/iftar_drive.jpg',
    'Emergency responses delivered (COVID-19, Green Town, Floods 2022, Yasmeen\'s Family)': '/drive/flood_relief.jpeg'
  }), [])
  ...
  const initiatives = useMemo<InitiativeData[]>(() => [
    {
      ...
      description: 'Fostering long-term economic sustainability and financial independence for lasting impact.',
    ...
    },
    {
      ...
      metrics: [
        ...
        { value: '1,000+', label: 'Families fed through food & cash assistance', sublabel: '' },
        { value: '30+', label: 'Iftar drives and meal distributions organized', sublabel: '' },
        { value: '10+', label: 'Emergency responses delivered (COVID-19, Green Town, Floods 2022, Yasmeen\'s Family)', sublabel: '' }
      ]
    }
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="flex flex-col h-full">
              <div>
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Project Salam</h3>
                ...
                <div className="space-y-6 mb-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">Information Technology</h4>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">Chess Training</h4>
                      <p className="text-muted-foreground">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">Social-Emotional Learning</h4>
                      <p className="text-muted-foreground">
              ...
              <div className="flex justify-start gap-3 mt-auto">
                <Button className="bg-accent hover:bg-accent/90 px-6 py-2" asChild>
              ...
              <div className="grid lg:grid-cols-5 gap-0">
                        ...
                        <div className="absolute inset-0">
                          <div className="w-full h-full relative overflow-hidden">
                            ...
                            <div 
                              ...
                              style={{
                                height: '0%',
                                background: 'linear-gradient(to top, #a7f3d0 0%, #6ee7b7 50%, #34d399 100%)',
                                opacity: 0.3,
                                filter: 'blur(2px)'
                              }}
                            ></div>
                            ...
                            {/* Animated Chart */}
                            <AnimatePresence>
                              <AnimatedChart hoveredMetric={hoveredMetric} metrics={metrics} />
                            </AnimatePresence>
                ...
                <div className="lg:col-span-3 px-8 pb-8 pt-0 flex flex-col justify-center">
                  ...
                  <div className="flex justify-end">
                    <Button asChild className="bg-primary hover:bg-primary/90 px-6 py-2">
                      <Link href={initiatives[0].href} aria-label={`Learn more about ${initiatives[0].title}`}>
              ...
              <div className="grid lg:grid-cols-5 gap-0">
                ...
                <div className="lg:col-span-3 pl-6 pr-8 pb-8 pt-0 flex flex-col justify-between order-2 lg:order-1">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-6">
                        {initiatives[1].metrics.map((metric, index) => (
                          <motion.div
                            key={index}
                            whileHover={{ scale: 1.02, y: -2 }}
                            onMouseEnter={() => setHoveredEmergencyMetric(metric.label)}
                          ...
                          >
                            <div className="relative z-10">
                              ...
                              <div className="text-xs text-muted-foreground font-medium">
                                {metric.sublabel ? `${metric.label} ${metric.sublabel}` : metric.label}
                              </div>
                            </div>
                          </motion.div>
                        ))}
                  ...
                  <div className="flex justify-start">
                    <Button asChild className="bg-accent hover:bg-accent/90 px-6 py-2">
                      <Link href={initiatives[1].href} aria-label={`Learn more about ${initiatives[1].title}`}>
