      ...
      <div className="relative w-full overflow-hidden" style={{ aspectRatio: "1910/600" }}>
        ...
        <video
          ...
          onEnded={(e) => {
            ...
            // Force restart the video to prevent grey screen
        ...
        <div className="absolute inset-0 flex items-center z-30">
          <div className="max-w-[1380px] w-full mx-auto px-6 md:px-10 lg:px-14">
            <div className="max-w-2xl space-y-8">
              <div>
                <motion.h1 className="text-4xl md:text-6xl font-bold text-balance font-space-grotesk h-20 md:h-32 flex items-start text-white [text-shadow:3px_3px_6px_rgba(0,0,0,1),_1px_1px_3px_rgba(0,0,0,0.8)]">
                  <TypewriterText
              ...
              <motion.p
                ...
                className="text-xl md:text-2xl text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] [text-shadow:3px_3px_6px_rgba(0,0,0,1),_1px_1px_3px_rgba(0,0,0,0.8)] text-pretty mt-18"
              >
                Through education, technology, and social-emotional learning, we're building stronger communities and
                brighter futures.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
